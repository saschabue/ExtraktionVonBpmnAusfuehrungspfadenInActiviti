...
public class ServiceTaskElementObject extends SuperElementObject {
	 ...
	 *            Element
	 */
	public ServiceTaskElementObject(final DelegateExecution execution) {
		super(execution);
	}
	...
	protected final ST templateImpl() {
		return new ST("//________________ServiceTask_Elementname:_<actualElement>___________________\n"
				+ "System.out.println(\"Ausführung Service Task: <actualElement>. Variablenwerte:\");\n"
				+ "<processVariables:{pv| System.out.println(\"Variable <pv.variableName> : "
				+ "<if(pv.isString)>\"<endif><pv.variableContent><if(pv.isString)>\"<endif>\");\n}>"
