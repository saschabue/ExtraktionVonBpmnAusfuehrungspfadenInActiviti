...
public class ProcessTest_processId_vortrag_2906_JUnit{
	...
	public void executeProcess() throws Exception {
		...
		//___User Task___
		//"variable1", false;
		System.out.println("Teilprozess (2890172) wurde beendet");//"variable1", false;
		System.out.println("Teilprozess (2890172) wurde beendet");
